...
{
    public partial class WomanForm : System.Web.UI.Page
    {
        ...
        double salarioTotalDep3; double salarioTotalDep4; double salarioTotalInd1; double salarioTotalInd2; string nombre; string id; string email;
        ...
        protected void BotonEnviarInd_Click(object sender, EventArgs e)
        {
            ...
            double porcentaje1 = montoInd * 0.10;
            double porcentaje2 = montoInd * 0.20;
            double porcentaje3 = montoInd * 0.02;
            double porcentaje4 = montoInd * 0.09;
            double por_monto1 = montoInd + porcentaje1;
            double por_monto2 = montoInd + porcentaje2;
            double por_monto3 = montoInd + porcentaje3;
            double por_monto4 = montoInd + porcentaje4;
            double salarioañoInd1 = salarioTotalInd1 * 12;
            double salarioañoInd2 = salarioTotalInd2 * 12;

            if (salarioInd > 0 && montoInd > 0 && salarioañoInd1 - por_monto2 > 1 && RadioButtonList2.Items[1].Selected ||
                salarioInd > 0 && montoInd > 0 && salarioañoInd2 - por_monto2 > 1 && RadioButtonList2.Items[1].Selected)
            {
                ...
                cn.Close();
                Response.Redirect("MujerEmprendedora.aspx?parametro1=" + nombre + "&parametro2=" + id + "&parametro3=" + montoInd);
                Response.Redirect("MujerEmprendedora.aspx");
            }

            else if (salarioInd > 0 && montoInd > 0 && salarioañoInd1 - por_monto4 < 1 && salarioañoInd1 - por_monto3 >= 0 ||
                     salarioInd > 0 && montoInd > 0 && salarioañoInd2 - por_monto4 < 1 && salarioañoInd1 - por_monto3 >= 0)
            {
                MailMessage mail = new MailMessage();
                mail.To.Add(new MailAddress(email));
                mail.From = new MailAddress("migueda1312@gmail.com");
                ...
                comando.ExecuteNonQuery();
                cn.Close();
                Response.Redirect("MujerEmprendedora2.aspx?parametro1=" + nombre);
                Response.Redirect("MujerEmprendedora2.aspx");
            }
            else if (salarioInd > 0 && montoInd > 0 && salarioañoInd1 - por_monto1 > 0 && salarioañoInd1 - por_monto2 > 1 ||
                salarioInd > 0 && montoInd > 0 && salarioañoInd2 - por_monto1 > 0 && salarioañoInd2 - por_monto2 > 1)
            {
                MailMessage mail = new MailMessage();
                mail.To.Add(new MailAddress(email));
                mail.From = new MailAddress("migueda1312@gmail.com");
                ...
                comando.ExecuteNonQuery();
                cn.Close();
                Response.Redirect("PrestamoAceptadoMujer.aspx?parametro1=" + nombre + "&parametro2=" + id);
                Response.Redirect("PrestamoAceptadoMujer.aspx");
            }
            else
            {
                MailMessage mail = new MailMessage();
        ...
        protected void BotonEnviarDep_Click(object sender, EventArgs e)
        {
            ...
            double porcentaje1 = montoDep * 0.10;
            double porcentaje2 = montoDep * 0.20;
            double porcentaje3 = montoDep * 0.02;
            double porcentaje4 = montoDep * 0.09;
            double por_monto1 = montoDep + porcentaje1;
            double por_monto2 = montoDep + porcentaje2;
            double por_monto3 = montoDep + porcentaje3;
            double por_monto4 = montoDep + porcentaje4;
            ...
            if (salarioDep > 0 && montoDep > 0 && salarioañoDep1 - por_monto1 >= 0 ||
           salarioDep > 0 && montoDep > 0 && salarioañoDep1 - por_monto1 >= 0 ||
           salarioDep > 0 && montoDep > 0 && salarioañoDep1 - por_monto1 >= 0 ||
           salarioDep > 0 && montoDep > 0 && salarioañoDep1 - por_monto1 >= 0)
            {
                MailMessage mail = new MailMessage();
            ...
            else if (salarioDep > 0 && montoDep > 0 && salarioañoDep1 - por_monto4 < 1 && salarioañoDep1 - por_monto3 >= 0 ||
           salarioDep > 0 && montoDep > 0 && salarioañoDep2 - por_monto4 < 1 && salarioañoDep1 - por_monto3 >= 0 ||
           salarioDep > 0 && montoDep > 0 && salarioañoDep3 - por_monto4 < 1 && salarioañoDep1 - por_monto3 >= 0 ||
           salarioDep > 0 && montoDep > 0 && salarioañoDep4 - por_monto4 < 1 && salarioañoDep1 - por_monto3 >= 0)
            {
                MailMessage mail = new MailMessage();
                mail.To.Add(new MailAddress(email));
                mail.From = new MailAddress("migueda1312@gmail.com");
