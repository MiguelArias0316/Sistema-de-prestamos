<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenForm.aspx.cs" Inherits="Sistema_de_prestamos.MenForm" %>
<!DOCTYPE html>
...
<div class="page-wrapper bg-red p-t-180 p-b-100 font-robo">
        ...
        <asp:Label ID="Label1" runat="server" Text="Bienvenido señor" Font-Bold="True" Font-Size="Large"></asp:Label>
...
<asp:DropDownList ID="DropDownList1" runat="server">
        ...
        <div id="divDep" runat="server" style="display: none" >
            ...
            <br />
            <br />
            <asp:TextBox ID="TextBox7" runat="server" TextMode="Number" BorderColor="Black" BorderWidth="2px" Width="137px"></asp:TextBox>
            <br />
            <br />
            ...
            <br />
            <br />
            <asp:Button ID="BotonEnviarDep" runat="server" Text="Enviar petición de prestamo" BorderColor="Black" OnClick="BotonEnviarDep_Click"    />
        <br />    
        </div>           
            <div id="divInd" runat="server" style="display: none">
                ...
                <br />
                <asp:Button ID="BotonEnviarInd" runat="server" Text="Enviar petición de prestamo" OnClick="BotonEnviarInd_Click"/>
                <br />
            </div>           
        <br />
    </form>            
